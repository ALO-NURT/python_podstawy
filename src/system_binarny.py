...
print("Liczba w systemie binarnym (liczba):")
liczba = str(input())
print("Liczba w systemie dziesiętnym:")
print(dekoduj_system_binarny(liczba))

print("Liczba w systemie dziesiętnym: (liczba):")
liczba = str(input())
print("Liczba w systemie binarny")
print(zamień_na_system_binarny(liczba))